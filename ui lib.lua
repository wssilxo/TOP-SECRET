...
function library.new(library_title, cfg_location)
	...
	local ImageLabel = library:create("ImageButton", {
		...
		BorderColor3 = Color3.fromRGB(234, 234, 234),
		Position = UDim2.new(0.5, 0, 0.5, 0),
		Size = UDim2.new(0, 700, 0, 500),
		Image = "http://www.roblox.com/asset/?id=12620450035",
	...
	function menu.new_tab(tab_image)
		...
		function tab.new_section(section_name)
			...
			local UIGradient = library:create("UIGradient", {
				Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(32, 33, 38)), ColorSequenceKeypoint.new(0.5, Color3.fromRGB(243, 243, 243)), ColorSequenceKeypoint.new(1, Color3.fromRGB(32, 33, 38))},
			}, SectionDecoration)
			...
			function section.new_sector(sector_name, sector_side)
				...
				function sector.element(type, text, data, callback, c_flag)
					...
					elseif type == "Slider" then
						...
						local UIGradient = library:create("UIGradient", {
							Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(239, 239, 239)), ColorSequenceKeypoint.new(1, Color3.fromRGB(163, 163, 163))},
							Rotation = 90,
						}, SliderFrame)
